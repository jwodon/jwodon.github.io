  ...
  <section id="about" className="about-section fade-in-up">
    ...
    <div className="about-block">
      ...
      <div className="experience-block">
        <h3><strong>Sr. Supplier Quality Engineer</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>Fictiv (Feb 2022 – Present)</strong>
        </p>
        <ul>
      ...
      <div className="experience-block">
        <h3><strong>Springboard Software Engineering Trainee</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>(Sep 2023 – Sep 2024)</strong>
        </p>
        <ul>
          ...
          <li>• Enabled users to log data and visualize metrics through interactive charts, enhancing engagement and insights.</li>
        </ul>
      </div>

      <div className="experience-block">
        <h3><strong>Quality Engineer</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>Hydro Flask (Feb 2021 – Feb 2022)</strong>
        </p>
        <ul>
          ...
          <li>• Prevented potential losses of over $30 million by identifying and resolving a critical manufacturing defect.</li>
        </ul>
      </div>

      <div className="experience-block">
        <h3><strong>Supplier Quality Engineer</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>Harry’s Inc. (Feb 2018 – Feb 2021)</strong>
        </p>
        <ul>
      ...
      <div className="experience-block">
        <h3><strong>Product Development Engineer</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>Boombah (Nov 2015 – Jan 2018)</strong>
        </p>
        <ul>
      ...
      <div className="experience-block">
        <h3><strong>Design Engineer</strong></h3>
        <p className="resume-sub" style={{ color: '#fff' }}>
          <strong>Percival Scientific (Jan 2015 – Nov 2015)</strong>
        </p>
        <ul>
    ...
    <div className="about-block">
      ...
      <p className="about-text">
        I enjoy video games, staying active through snowboarding, baseball, and weightlifting, 
        and exploring new places with my two dogs, Finn and Rey. I'm currently restoring a 1990 
        Ford Bronco II, which has been a fun hands-on project. I'm also a big movie buff who 
        loves traveling and trying new foods.
      </p>
    </div>
